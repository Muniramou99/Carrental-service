	...
	{		
		...
		{ 
			if(!empty($_POST["remember"]))
			{
				...
				<input type="text" placeholder="Enter Username" name="uname"value="<?php if(isset($_COOKIE['member_login'])){echo $_COOKIE['member_login'];}?>"   required>
				<br>
				<label for="psw"><b style="color:#DAA520">Password</b></label>
				<input type="password" placeholder="Enter Password" name="psw" value="<?php if(isset($_COOKIE['member_password'])){echo $_COOKIE['member_password'];}?>" required>
				<br>
				<label>
				...
				<span class="psw">you don't have account? <a href="../php/userregister.php"><b style="color:#DAA520;font-size:20px;">signup?</b></a></span>
				</div>
